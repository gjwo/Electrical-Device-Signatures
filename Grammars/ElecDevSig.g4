...
year                : ( DIGITS2 | DIGITS4);
day_of_month        : DIGITS2;
...
power				: number POWER_UNIT | power_range;
power_range         : LBRACE number POWER_UNIT COLON  number POWER_UNIT shape? RBRACE;
shape               : (FLAT | RISING | FALLING | RANDOM);
